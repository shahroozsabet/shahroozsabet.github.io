    ...
    return (<Grid container direction={"column"}>
        <Head>
            ...
            <meta
                property="og:url"
                key="og:url"
                content="https://shahrooz.herokuapp.com/revolution"
            />
            <link
                rel="canonical"
                key="canonical"
                href="https://shahrooz.herokuapp.com/revolution"
            />
        </Head>
        <Grid
            item
            ...
            >
                <Grid item>
                    <Typography
                        ...
                        align={matchesMD ? "center" : undefined}
                        gutterBottom
                        style={{color: "black", marginTop: matchesMD ? 0 : "5em"}}
                    >
                        Consultation
                    </Typography>
                </Grid>
            ...
            >
                <Grid item>
                    <Typography
                        ...
                        variant={"h4"}
                        gutterBottom
                        style={{color: "black", marginTop: "5em"}}
                    >
                        MockUp
                    </Typography>
                </Grid>
                <Grid item>
                    ...
                    >
                        ...
                        MVP doesn’t include colors, images, or any other polished design elements,
                        but captures the essential layout structure and functionality.
                    </Typography>
                    <Typography
                        variant={"body1"}
                        align={matchesMD ? "center" : undefined}
            ...
            >
                ...
                <Grid item>
                    ...
                    >
                        ...
                        we get down to fine-details of design.
                    </Typography>
                </Grid>
            </Grid>
            <Grid item lg style={{alignSelf: "center"}}>
